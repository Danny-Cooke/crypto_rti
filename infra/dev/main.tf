...
module "storage" {
  source = "../../modules/infra/dev/storage"
  ...
  storage_s3_raw_lifecycle_glacier_days = var.storage_s3_raw_lifecycle_glacier_days
...
module "compute" {
  ...
  compute_ami_filter       = var.compute_ami_filter
  compute_ami_architecture = var.compute_ami_architecture
